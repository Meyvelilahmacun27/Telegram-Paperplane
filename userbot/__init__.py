...
API_KEY = os.environ.get("API_KEY", '1295733')

API_HASH = os.environ.get("API_HASH", '04d71a287680e01fc9f29f6705590037')

BOTLOG = sb(os.environ.get("BOTLOG", "True"))

BOTLOG_CHATID = int(os.environ.get("-490298110")) if BOTLOG else 0
